...
class RequestAdapter(
...
) : ListAdapter<Requests, RequestAdapter.RequestViewHolder>(RequestDiffCallback()) {
    var mobile = ""
    ...
    inner class RequestViewHolder(val binding: RequestLayoutBinding) :
        ...
        fun bind(request: Requests) {
            ...
            binding.tvPetName.text = spanned("<b>Name:</b> ${request.userName}")
            binding.tvPetAge.text = spanned("<b>Mobile:</b> ${request.userMobile}")
            binding.tvStatus.text = spanned("<b>Status:</b> ${request.status}")
            binding.editTextText2.setText(spanned("<b>Request:</b> ${request.date} ${request.message}"))
    ...
    override fun onBindViewHolder(holder: RequestViewHolder, position: Int) {
        ...
        if (role == "Hotel"){
            holder.binding.editTextText2.visibility = View.VISIBLE
        }
