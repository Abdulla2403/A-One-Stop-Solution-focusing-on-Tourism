...
class RequestAdapter3(
    private val itemOnClick: (Requests) -> Unit,
    private val statusOnClick: (Requests) -> Unit,
    private val role: String
) : ListAdapter<Requests, RequestAdapter3.RequestViewHolder>(RequestDiffCallback()) {
    var mobile = ""
    ...
    inner class RequestViewHolder(val binding: RequestLayoutBinding) :
        ...
        fun bind(request: Requests) {
            ...
            binding.editTextText2.setText(spanned("<b>Status:</b> ${request.date},${request.message}"))
            ...
            if (role == "Hotel") {
                ...
                binding.editTextText2.isVisible = true
